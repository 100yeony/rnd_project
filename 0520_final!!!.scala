...
def evaluation(std_NO:Int, recommed_list:List[String]):(Float, Float, Float)={
  // var i = INTEREST(std_NO)
  ...
  val sbjt_origin_temp3 = sbjt_origin_temp2.select("SBJT_KEY_CD").limit(30)
...
object Main{
  def main(args:Array[String]):Unit={
    ...
    var evaluation_test = evaluation(std_no, r)
    // var r = recResult(std_no, t, c, i._1, i._2, i._3)._1.toList
    // var r = recResult(std_no, t, c, i._1, i._2, i._3) //return하는거 수정해서 <예측결과셋 리스트>
  }
}
